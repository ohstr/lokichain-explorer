...
const EPOCH_BLOCK_LENGTH = 1; // mainnet #FLZ_CHANGE
...
function getNextBlockSubsidy(height: number): number {
  ...
  let subsidy = BigInt(1000 * 100_000_000);
  // Subsidy is cut in half every 210,000 blocks which will occur approximately every 5 months.
