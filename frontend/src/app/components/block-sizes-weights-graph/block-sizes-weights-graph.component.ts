...
export class BlockSizesWeightsGraphComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.seoService.setDescription($localize`:@@meta.description.bitcoin.graphs.block-sizes:See Flokicoin block sizes (MB) and block weights (weight units) visualized over time.`);
