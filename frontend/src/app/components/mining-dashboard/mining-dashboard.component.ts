...
export class MiningDashboardComponent implements OnInit, AfterViewInit {
  ...
  ngOnInit(): void {
    ...
    this.seoService.setDescription($localize`:@@meta.description.mining.dashboard:Get real-time Flokicoin mining stats like hashrate, difficulty adjustment, block rewards, pool dominance, and more.`);
