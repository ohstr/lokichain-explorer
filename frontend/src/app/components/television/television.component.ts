...
export class TelevisionComponent implements OnInit, OnDestroy {
  ...
  ngOnInit() {
    ...
    this.seoService.setDescription($localize`:@@meta.description.tv:See Flokicoin blocks and mempool congestion in real-time in a simplified format perfect for a TV.`);
