      ...
      tooltip: {
        ...
        formatter: (ticks) => {
          ...
          if (ticks[0].data[1] > 10_000_000) {
            tooltip += `${ticks[0].marker} ${ticks[0].seriesName}: ${formatNumber(ticks[0].data[1] / 100_000_000, this.locale, '1.0-8')} FLC<br>`;
          } else {
            tooltip += `${ticks[0].marker} ${ticks[0].seriesName}: ${formatNumber(ticks[0].data[1], this.locale, '1.0-0')} loki<br>`;
          }
