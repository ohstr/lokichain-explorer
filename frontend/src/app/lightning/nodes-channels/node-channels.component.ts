          ...
          tooltip: {
            ...
            formatter: (value): string => {
              ...
              if (value.data.value > 100000000) {
                capacity = formatNumber(Math.round(value.data.value / 100000000), this.locale, '1.2-2') + ' FLC';
              } else {
                capacity = <string>this.amountShortenerPipe.transform(value.data.value, 2) + ' loki';
              }
