      ...
      tooltip: {
        ...
        formatter: (ticks): string => {
          return `
            ...
            <span>Capacity: ${this.amountShortenerPipe.transform(ticks[0].data.capacity, 2, undefined, true)} loki</span><br>
            <span>Channels: ${ticks[0].data.count}</span><br>
            <br>
            <b style="color: white; margin-left: 2px">${ticks[1].marker} Incoming</b><br>
            <span>Capacity: ${this.amountShortenerPipe.transform(ticks[1].data.capacity, 2, undefined, true)} loki</span><br>
      ...
      yAxis: sum === 0 ? undefined : [
        {
          ...
          axisLabel: {
            ...
            formatter: (val) => {
              return `${this.amountShortenerPipe.transform(Math.abs(val), 2, undefined, true)} loki`;
            }
          },
          splitLine: {
            lineStyle: {
