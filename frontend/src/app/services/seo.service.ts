...
export class SeoService {
  network = '';
  baseTitle = 'mempool';
  baseDescription = 'Explore the full Flokicoin ecosystem&reg; with The Mempool Open Source Project&reg;.';
  ...
  getTitle(): string {
    if (this.network === 'testnet')
      return this.baseTitle + ' - Flokicoin Testnet3';
    if (this.network === 'testnet4')
      return this.baseTitle + ' - Flokicoin Testnet4';
    if (this.network === 'signet')
      return this.baseTitle + ' - Flokicoin Signet';
