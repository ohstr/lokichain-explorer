...
export const restApiDocsData = [
  ...
  },
  {
    ...
    title: "GET Price",
    description: {
      default: "Returns flokicoin latest price denominated in main currencies."
    },
    urlString: "/v1/prices",
    showConditions: [""],
  ...
  },
  {
    ...
    description: {
      default: "Returns flokicoin historical price denominated in main currencies. Available query parameters: <code>currency</code>, <code>timestamp</code>. If no parameter is provided, the full price history for all currencies is returned."
    },
...
`
  ...
  },
  {
    ...
    description: {
      default: "Get the current total supply of the specified asset. For the native asset (L-FLC), this is calculated as [chain,mempool]_stats.peg_in_amount - [chain,mempool]_stats.peg_out_amount - [chain,mempool]_stats.burned_amount. For issued assets, this is calculated as [chain,mempool]_stats.issued_amount - [chain,mempool]_stats.burned_amount. Not available for assets with blinded issuances. If /decimal is specified, returns the supply as a decimal according to the asset's divisibility. Otherwise, returned in base units."
    },
...
"blockFeeRates": [
  ...
  "ispRanking": [
    [
      ...
      43681728521,       //aggregate capacity, in loki
  ...
  "ispRanking": [
    [
      ...
      220063321,                //aggregate capacity, in loki
          ...
          response: `[
  {
    ...
    "btcDue": "0.000625",
    "addresses": {
      "FLC": "bc1qcvqx2kr5mktd7gvym0atrrx0sn27mwv5kkghl3m78kegndm5t8ksvcqpja",
      "BTC_LNURLPAY": null,
