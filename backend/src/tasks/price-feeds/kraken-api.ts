  ...
  public async $insertHistoricalPrice(): Promise<void> {
    ...
    for (const currency of this.currencies) {
      ...
      for (const price of priceHistoryRaw) {
        ...
        let formatedPrice = price[4]
        formatedPrice = formatedPrice / 10000000; // #FLZ_CHANGE
        formatedPrice = Math.round(formatedPrice * 10000) / 10000;

        priceHistory[price[0]][currency] = formatedPrice;
      }
    }
